...
void startUpPhase::TESTautoAssignTroops() {
	...
	player1->getCountriesOwned()->at(2)->setOwnerID(*player1->getID());
	player1->getCountriesOwned()->at(2)->setTroopCount(1);
	...
	player2->getCountriesOwned()->at(2)->setOwnerID(*player2->getID());
	player2->getCountriesOwned()->at(2)->setTroopCount(1);
